...
namespace RepairedShopr
{
    ...
    public partial class MainWindow : Form
    {
        ...
        private async void MainWindow_Load(object sender, EventArgs e)
        {
            ...
            _APIClient.LoadAPI();
            APIClient.RootObject tickets = await _APIClient.SearchTickets();
            //foreach (APIClient.Ticket ticket in tickets.tickets)
            //{
            //    listView1.Items.Add(new ListViewItem(new string[] { ticket.number.ToString(), ticket.customer_business_then_name, ticket.comments[ticket.comments.Count - 1].body }));
            //} //ListView Code
        ...
        private async void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            APIClient.RootObject tickets = await _APIClient.SearchTickets(query);
